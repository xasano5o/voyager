...
const Footer = () => {
    return (
        <div className=' w-full bg-black'>
            <div className="lg:pl-8 mt-4 w-[1024px] h-[88px] flex-col justify-start items-center gap-6 inline-flex">
            ...
            <div className="lg:pl-8 w-[1024px] h-[234px] flex-col justify-between items-center inline-flex">
