...
const Order = () => {
    ...
    return (
        <div className='mt-12'>
            <div className="w-[1024px] h-[148px] flex-col justify-start items-start gap-[30px] inline-flex">
                <div className="w-[404px] h-[45px] p-2.5 border border-neutral-400 justify-between items-center inline-flex">
                    <div className="h-[35px] py-2 bg-black justify-start items-center flex">
                        <div className="grow shrink basis-0 text-center text-white text-base font-semibold font-['Syne']">One-way</div>
                    </div>
                    <div className="grow shrink basis-0 self-stretch px-[15px] py-2.5 rounded-[40px] justify-start items-center gap-2.5 flex">
                        <div className="grow shrink basis-0 text-center text-zinc-500 text-base font-semibold font-['Syne']">Roundtrip</div>
                    </div>
                    <div className="h-[39px] px-[15px] py-2.5 rounded-[40px] justify-start items-center gap-2.5 flex">
                        <div className="grow shrink basis-0 text-center text-zinc-500 text-base font-semibold font-['Syne']">Hourly</div>
                    </div>
                </div>
                <div className="w-[1024px] h-[73px] justify-start items-end gap-6 inline-flex">
