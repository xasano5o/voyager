        ...
        <div>
            <div className="mt-12 w-[1024px] flex-col justify-start items-center gap-[91px] inline-flex">
                <div className="justify-start items-start gap-[17px] inline-flex">
                    <div className="w-[515px] flex-col justify-start items-start gap-[50px] inline-flex">
                        ...
                        <div className="self-stretch h-44 flex-col justify-start items-start gap-5 flex">
                            ...
                            <div className="text-black text-base font-medium font-['Syne'] underline tracking-wide">Learn more</div>
                        </div>
                    </div>
                ...
                <div className="w-[246px] h-[41px] px-2.5 bg-black justify-center items-center gap-5 inline-flex">
                    <div className="grow shrink basis-0 text-center text-white text-[13px] font-semibold font-['Syne'] tracking-wide">GET STARTED</div>
                </div>
            </div>
        </div>
    )
